...
from modules.func_spaman.pro_spaman import command_spaman_for_link, command__spaman_cd
    ...
    def onMessage(self, mid, author_id, message, message_object, thread_id, thread_type):
        try:
            ...
            if message_text.startswith(f"{prefix}nt go"):
                ...
                command__spaman_cd(message, message_object, thread_id, thread_type, author_id, self)
